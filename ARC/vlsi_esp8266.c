...
int vlsi_esp8266_get_replay(VLSI_ESP *obj, char* buf, int time_out)
{
  for(;;)
  {
...
int vlsi_esp8266_wait_replay(VLSI_ESP *obj)
{
  for(;;)
  {
    board_delay_ms(100, 1);
...
int vlsi_esp8266_set_baud(VLSI_ESP *obj, int baud)
{
  ...
  int f = vlsi_esp8266_wait_replay(obj);
...
int vlsi_esp8266_test(VLSI_ESP *obj)
{
  ...
  char buf[100] = {0};
  /* int f = vlsi_esp8266_get_replay(obj, buf, 100); */
  int f = vlsi_esp8266_wait_replay(obj);
...
int vlsi_esp8266_connect(VLSI_ESP *obj, char* ssid, char* key)
{
  ...
  /* int f = vlsi_esp8266_get_replay(obj, NULL, 100); */
  int f = vlsi_esp8266_wait_replay(obj);
  return f;
}
...
int vlsi_esp8266_server(VLSI_ESP *obj)
{
  ...
  /* f = vlsi_esp8266_get_replay(obj, NULL, 100); */
  f = vlsi_esp8266_wait_replay(obj);
...
int vlsi_esp8266_send(VLSI_ESP *obj, char *buf, char idp)
{
  ...
  /* obj->uart->uart_write(cmd, sizeof(cmd)); */
  obj->uart->uart_write(cmd, sizeof(cmd));
  int f = vlsi_esp8266_get_replay(obj, NULL, 420);
  ...
  f = vlsi_esp8266_get_replay(obj, NULL, 420);
  return 0;
}
